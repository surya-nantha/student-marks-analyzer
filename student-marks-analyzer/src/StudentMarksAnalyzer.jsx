...
const StudentMarksAnalyzer = () => {
  ...
  useEffect(() => {
    const sampleStudents = [
      { id: 1, name: 'Raj Kumar', class: '6', tamil: 8, english: 6, maths: 9 },
      { id: 2, name: 'Priya Singh', class: '6', tamil: 5, english: 7, maths: 4 },
      { id: 3, name: 'Arjun Patel', class: '7', tamil: 9, english: 8, maths: 10 },
      { id: 4, name: 'Meera Sharma', class: '7', tamil: 3, english: 5, maths: 6 },
      { id: 5, name: 'Kiran Reddy', class: '8', tamil: 7, english: 9, maths: 8 },
      { id: 6, name: 'Divya Nair', class: '8', tamil: 2, english: 4, maths: 3 },
      { id: 7, name: 'Rohit Gupta', class: '9', tamil: 10, english: 8, maths: 9 },
      { id: 8, name: 'Kavya Joshi', class: '9', tamil: 6, english: 7, maths: 5 },
    ];
  ...
  const AddStudentForm = () => {
    const [newStudent, setNewStudent] = useState({
      name: '', class: '6', tamil: '', english: '', maths: ''
    });
    ...
    const handleSubmit = () => {
      ...
      setNewStudent({ name: '', class: '6', tamil: '', english: '', maths: '' });
        ...
        {activeTab === 'dashboard' && (
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
              ...
              {classes.map(cls => (
                <div key={cls} className="bg-white p-6 rounded-lg shadow-sm">
                  <div className="flex items-center justify-between">
                    <div>
                      <p className="text-gray-500">Class {cls}</p>
                      <p className="text-2xl font-bold text-green-600">{stats.byClass[cls] || 0}</p>
                    </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-sm">
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  {classes.map(cls => (
                    <p key={cls} className="text-gray-600">Class {cls}: {stats.byClass[cls] || 0} students</p>
                  ))}
                </div>
              </div>
            </div>
